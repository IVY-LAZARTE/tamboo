<div>
                        ...
                        @foreach ($users as $user)
                            <tr wire:key="{{ $user->email }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap  text-sm font-medium">
                                    <a class="btn btn-red cursor-pointer"
                                        wire:click="$emit('deleteUsuario',{{ $user->id }})">
    ...
    <script>
        Livewire.on('deleteUsuario', usuarioId => {
            Swal.fire({
                title: 'Estas seguro de eliminar este usuario? Si tiene asignada una empresa este tambien se eliminará ',
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('admin.user-component', 'delete', usuarioId);
