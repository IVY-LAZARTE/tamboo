<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-lg shadow-lg px-12 py-8 mb-6 flex items-center">
        ...
        <div class="relative">
            <div class="{{ ($order->status >= 2 && $order->status != 5) ? 'bg-blue-400' : 'bg-gray-400' }}  rounded-full h-14 w-14 flex items-center justify-center">
...
--}}
        ...
        <div class="relative">
            <div class="{{ ($order->status >= 4 && $order->status != 5) ? 'bg-blue-400' : 'bg-gray-400' }} rounded-full h-14 w-14 flex items-center justify-center">
