<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <aside>
            <h2 class="font-semibold text-white text-center mb-2">Subcategorías</h2>
            <ul class="divide-y  divide-gray-200">
                @foreach ($category->subcategories as $subcategory)
                <li class="py-2 text-sm">
                    <a class=" text-white cursor-pointer hover:text-red-700 capitalize {{ $subcategoria == $subcategory->slug ? 'text-white-500 font-semibold' : '' }}"
            ...
            <x-danger-enlace class="mt-4 cursor-pointer" wire:click="limpiar">
                Eliminar filtros
            </x-danger-enlace>
        </aside>
                ...
                <li class="bg-white rounded-lg shadow">
                    <article>
                        ...
                        <div class="py-4 px-6">
                            ...
                            <p class="font-bold text-trueGray-700">Bs {{$product->price}}</p>
                        </div>
                    </article>
                </li>
