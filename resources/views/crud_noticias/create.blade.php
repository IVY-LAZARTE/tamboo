...
<body>
    <div class="container">
        <h4 class="text-center my-4"> Registrar Nueva Noticia</h4>
        <div class="row">
            <div class="col-xl-12" style="background-color: white; box-shadow:5px 6px 9px; border-radius:8px">
                <form action="{{route('crud_noticias.store')}}" method="post" enctype="multipart/form-data" >
                @csrf   
                <div class="form-group">
                        <label for="titulo_noticia"><b>Titulo de Noticia</b></label>
                        <input type="text" class="form-control" name="titulo_noticia" required max-length="100" >
                       
                    </div>
                    <div class="form-group">
                        <label for="tipo_noticia"><b>Tipo de Noticia</b></label>
                        <input type="text" class="form-control" name="tipo_noticia" required max-length="100" >
