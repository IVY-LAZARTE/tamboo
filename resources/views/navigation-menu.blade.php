    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
           ...
           @can('admin.producto')
            ...
            <x-jet-responsive-nav-link href="{{route('admin.comprobante.index')}}" :active="request()->routeIs('admin.categories.*')">
                        Comprobantes
                    </x-jet-responsive-nav-link>
            @endcan
             @can('admin.user')
                    ...
                    <x-jet-responsive-nav-link href="{{route('admin.promociones.index')}}" :active="request()->routeIs('crud_noticias.index')">
                        Promociones
                      </x-jet-responsive-nav-link>
                                         
                      <x-jet-responsive-nav-link href="{{route('admin.noticias.index')}}" :active="request()->routeIs('crud_promocion.index')">
                          Noticias
                      </x-jet-responsive-nav-link>
         @endcan
             {{-- <x-jet-responsive-nav-link href="{{route('admin.categories.index')}}" :active="request()->routeIs('admin.categories.*')">
